        ...
        return (
            <div className="flex flex-row">
                <button
                    ...
                    className="bg-gradient-1 flex  shrink-0 items-center justify-center rounded-full   border border-primary bg-opacity-90 px-4 py-2 text-white hover:bg-opacity-75 "
                >
