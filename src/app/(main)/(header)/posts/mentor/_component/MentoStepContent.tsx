...
import SectionDivider from '@/app/(main)/_component/SectionDivider';
import UserIcon from '@/app/_icons/common/UserIcon';
import { usePostsStore } from '@/app/(main)/_store/postsStore';
