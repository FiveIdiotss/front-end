...
function RightSideBar() {
    return (
        <div className="  flex flex-col gap-2 mobile:flex-row   ">
            <div className="flex w-full flex-col gap-4 rounded-md border border-neutral-300 p-3 mobile:w-72">
                ...
                <div className="flex flex-col ">
                    {HOT_POSTS.map((post, index) => (
                        <div
                            ...
                            key={index}
                        >
                            <span className=" rounded-md   text-sm font-extralight text-neutral-700">{post.title}</span>
