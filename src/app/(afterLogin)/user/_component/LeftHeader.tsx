...
import LogoutIcon from '../../_component/icon/LogoutIcon';
...
function LeftHeader() {
    ...
    return (
        <div className="shadow-right flex h-full  w-full  flex-col      gap-12 border-x border-gray-300 p-10 ">
            <div className="flex w-full flex-col items-center justify-center ">
                <div className="relative">
                    ...
                    />
                    <div className="absolute -right-1 top-[67px] h-7 w-7 rounded-full border-2 border-white bg-primary p-[4px]">
