...
function MentoringRequestCard({ data }: { data: MentoringReq }) {
    return (
        <section className="mb-4 flex  w-full flex-col gap-6 rounded-lg border border-neutral-300 bg-white p-4 shadow-sm shadow-neutral-100">
            <header className="flex flex-row items-end justify-between">
                <span className="text-base font-semibold text-neutral-800">{data.date.replaceAll('-', '.')} 신청</span>
                ...
                <div className="flex flex-grow flex-col gap-3 px-3  py-2">
                    ...
                    <div className="flex w-full flex-col items-start gap-2">
                        ...
                        <div className="flex w-full flex-row items-end justify-between">
                            ...
                            <span className="text-sm underline underline-offset-2  hover:cursor-pointer hover:font-semibold">
                                상세이동
                            </span>
                        </div>
                    </div>
