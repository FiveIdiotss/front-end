...
async function Header() {
    ...
    return (
        <nav className="sticky top-0  z-[1001]  flex  h-[69px]  w-full  flex-shrink-0  flex-row  items-center justify-center border-b  border-neutral-200  bg-white px-6  ">
            <div className="flex h-full w-full flex-row items-center justify-center ">
                ...
                {/* <HeaderSearch /> */}
                <div className=" ml-8 flex h-full flex-grow  flex-row items-center justify-start gap-5 pt-1 ">
